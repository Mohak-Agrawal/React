...
export class PracticeQuestionsScreen extends Component {
    ...
    componentDidMount(){
      ...
      firebase.firestore().
        ...
        collection('Subjects').
        doc(params.subjectName).
        collection('Topics').
        doc(params.topicName).
        collection('Lectures').
        doc(params.lectureName).
        collection('Evaluations').
        doc("PracticeEvaluation").
    ...
    onSaveAndNext = () => {
        const{question,first,second,third,fourth,imageOptions,imageQuestion,correctOptions,questionId,className,subjectName,topicName,lectureName} = this.state
...
const useStyles = ((theme) => ({
  ...
  export default withStyles(useStyles)(PracticeQuestionsScreen)